...
static void event_2_0(
  common_data_t *common_data, void *usr_data,
  bt_bool cf_1, const char* cf_2, uint64_t cf_3, int64_t cf_4, const char* pf_2, bt_bool pf_1, uint64_t pf_3, int64_t pf_4)
{
  data_t *data = (data_t *) usr_data;
...
void btx_register_usr_callbacks(name_to_dispatcher_t** name_to_dispatcher) {
  btx_register_callbacks_event_1(name_to_dispatcher, &event_2_0);
  btx_register_callbacks_event_2(name_to_dispatcher, &event_1_0);
}
