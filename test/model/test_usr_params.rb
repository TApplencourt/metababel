    ...
    @btx_components = [
      {
        ...
        btx_component_params: 'param_1="a",param_2=true,param_3=1,param_4=+9223372036854775808',
...
class TestUserParamsDefault < Test::Unit::TestCase
  include GenericTest
  extend VariableAccessor
  include VariableClassAccessor
    ...
    @btx_components = [
      {
        ...
        btx_component_downstream_model: './test/model/cases_usr_params/1.btx_model.yaml',
        btx_component_params_model: './test/model/cases_usr_params/1.btx_params.yaml',
        btx_file_usr_callbacks: './test/model/cases_usr_params/2.callbacks.c',
      },
    ]
  end
end
