...
class TestSourceFields1 < Test::Unit::TestCase
    ...
    # Need to change component path to avoid race condition.
    # Also need to change plugging names to avoid separate componets to collide
    # because the same name
    BTX_PLUGGIN_NAME = 'metababel_tests_1'
    BTX_COMPONENT_PATH = './test/SOURCE.metababel_1'
