    ...
    @btx_components = [
      {
        ...
        btx_component_downstream_model: './test/cases_source_stream_classes_model/1.btx_model.yaml',
...
class TestSourceNoPayloadField < Test::Unit::TestCase
  ...
  def self.startup
    @btx_components = [
      {
        btx_component_type: 'SOURCE',
        btx_component_downstream_model: './test/cases_source_stream_classes_model/2.btx_model.yaml',
...
class TestSourceCommonPayloadFields < Test::Unit::TestCase
  ...
  def self.startup
    @btx_components = [
      {
        btx_component_type: 'SOURCE',
        btx_component_downstream_model: './test/cases_source_stream_classes_model/4.btx_model.yaml',
...
class TestSourceHundredFields < Test::Unit::TestCase
  ...
  def self.startup
    @btx_components = [
      {
        btx_component_type: 'SOURCE',
        btx_component_downstream_model: './test/cases_source_stream_classes_model/5.btx_model.yaml',
...
class TestSourceDetailsComparisonAllTypes < Test::Unit::TestCase
  ...
  def self.startup
    @btx_components = [
      {
        btx_component_type: 'SOURCE',
        btx_component_downstream_model: './test/cases_source_stream_classes_model/6.btx_model.yaml'
      },
      {
...
class TestSourceDetailsComparisonIntegersNoFieldRange < Test::Unit::TestCase
  ...
  def self.startup
    @btx_components = [
      {
        btx_component_type: 'SOURCE',
        btx_component_downstream_model: './test/cases_source_stream_classes_model/7.btx_model.yaml'
      },
      {
        btx_component_type: 'SINK',
        btx_component_name: 'details',
...
class TestSourceDetailsComparisonIntegers64DifferentBases < Test::Unit::TestCase
  ...
  def self.startup
    @btx_components = [
      {
        btx_component_type: 'SOURCE',
        btx_component_downstream_model: './test/cases_source_stream_classes_model/8.btx_model.yaml'
      },
      {
        btx_component_type: 'SINK',
        btx_component_name: 'details',
...
class TestSourceDetailsComparisonIntegers32DifferentBases < Test::Unit::TestCase
  ...
  def self.startup
    @btx_components = [
      {
        btx_component_type: 'SOURCE',
        btx_component_downstream_model: './test/cases_source_stream_classes_model/9.btx_model.yaml'
      },
      {
        btx_component_type: 'SINK',
        btx_component_name: 'details',
