...
static void roger(void *btx_handle, void *usr_data, int32_t i, int32_t j, uint32_t k) {
    printf("ROGER %" PRId32 "\n", i);
}

static void bernard(void *btx_handle, void *usr_data, int32_t i, int32_t j, uint32_t k) {
